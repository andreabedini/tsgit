...
const SYMBOLS = {
  ...
  git_revwalk_push_glob: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.i32 },
  ...
  git_commit_header_field: { args: [FFIType.ptr, FFIType.ptr, FFIType.cstring], returns: FFIType.i32 },
